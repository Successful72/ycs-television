...
def main():
    ...
    for filepath in files:
        ...
        for name, url in entries:
            ...
            channel_map[std_name][url_norm] = name
            total_matched += 1
